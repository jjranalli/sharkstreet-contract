...
export interface SharkStreetV2TestInterface extends utils.Interface {
  contractName: "SharkStreetV2Test";
  functions: {
    "_mintRaffle(address)": FunctionFragment;
    "_setBaseTokenURI(string)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "_mintRaffle", values: [string]): string;
  encodeFunctionData(
    functionFragment: "_setBaseTokenURI",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface SharkStreetV2Test extends BaseContract {
  contractName: "SharkStreetV2Test";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SharkStreetV2TestInterface;
  ...
  callStatic: {
    _mintRaffle(account: string, overrides?: CallOverrides): Promise<void>;
