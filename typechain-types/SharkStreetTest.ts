...
export interface SharkStreetTestInterface extends utils.Interface {
  contractName: "SharkStreetTest";
  functions: {
    "_setTokenURI(string)": FunctionFragment;
...
export interface SharkStreetTest extends BaseContract {
  contractName: "SharkStreetTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SharkStreetTestInterface;
  ...
  callStatic: {
    _setTokenURI(tokenURI_: string, overrides?: CallOverrides): Promise<void>;
